      ...
      child: DemoTemplateScaffold(
        ...
        header: LayoutBuilder(
          builder: (context, constraints) {
            final frameNarrow = !mobile && constraints.maxWidth < 560;
            return Container(
              padding: EdgeInsets.symmetric(horizontal: mobile ? 12 : (frameNarrow ? 12 : 24), vertical: 14),
              ...
              child: mobile
                  ? Row(
                      children: [
                        const Text('CloudStack', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: Color(0xFF635BFF))),
                        const Spacer(),
                        FilledButton(onPressed: () {}, style: FilledButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8)), child: const Text('Start', style: TextStyle(fontSize: 12))),
                      ],
                    )
                  : frameNarrow
                      ? Row(
                          children: [
                            const Text('CloudStack', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: Color(0xFF635BFF))),
                            const Spacer(),
                            OutlinedButton(onPressed: () {}, style: OutlinedButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8)), child: const Text('Sign in', style: TextStyle(fontSize: 12))),
                            const SizedBox(width: 6),
                            FilledButton(onPressed: () {}, style: FilledButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8)), child: const Text('Start trial', style: TextStyle(fontSize: 12))),
                          ],
                        )
                      : Row(
                          children: [
            ...
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Financial infrastructure\nfor modern teams', textAlign: TextAlign.center, style: TextStyle(fontSize: mobile ? 22 : 32, fontWeight: FontWeight.w800, height: 1.15, color: const Color(0xFF0F172A))),
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  spacing: 20,
                  runSpacing: 8,
                  children: ['Acme', 'Globex', 'Initech', 'Umbrella'].map((l) => Text(l, style: TextStyle(color: Colors.grey.shade400, fontWeight: FontWeight.w700, fontSize: 16))).toList(),
                ),
              ),
              Padding(
