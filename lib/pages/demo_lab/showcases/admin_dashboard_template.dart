...
class _AdminDashboardTemplateState extends State<AdminDashboardTemplate> {
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(_navItems[i].$2, style: TextStyle(fontSize: 13, fontWeight: sel ? FontWeight.w600 : FontWeight.normal, color: sel ? const Color(0xFF2563EB) : const Color(0xFF64748B))),
                            ],
                          ),
                        ),
                      ),
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(_navItems[_nav].$2, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
                      ...
                      Container(
                        ...
                        child: DataTable(
                          ...
                          columns: const [
                            DataColumn(label: Text('Order', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12))),
                            DataColumn(label: Text('Customer', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12))),
  ...
  DataRow _orderRow(String id, String name, String amt, String status, Color bg, Color fg) {
    return DataRow(cells: [
      ...
      DataCell(Text(amt, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600))),
      DataCell(Container(
